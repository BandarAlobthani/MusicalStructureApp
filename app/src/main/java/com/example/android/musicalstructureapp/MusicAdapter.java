...
public class MusicAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView mSongNameTextView = (TextView) listItemView.findViewById(R.id.song_name_text_view);
        // Get the Song Name resource ID from the current Music object and
        // set the text to TextView
        mSongNameTextView.setText(music.getmSongName());

        // Find the TextView in the list_item.xml layout with the ID artist_name_text_view
        TextView mArtistNameTextView = (TextView) listItemView.findViewById(R.id.artist_name_text_view);
        // Get the Artist Name resource ID from the current Music object and
        // set the text to TextView
        mArtistNameTextView.setText(music.getmArtistName());

        // Find the ImageView in the list_item.xml layout with the ID list_item_icon
        ImageView iconView = (ImageView) listItemView.findViewById(R.id.list_item_icon);
        // Get the image resource ID from the current AndroidFlavor object and
        // set the image to iconView
        iconView.setImageResource(music.getmImageResourceId());
